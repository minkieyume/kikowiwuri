...
#+date: 2025-7-5T13:16:41
#+modified: 2026-02-28T13:16:41
#+tags: 程序 折腾 guile emacs
#+summary: 考虑到emacs和guile文档实在太少，就试着把折腾的过程记录下来吧，方便日后复盘。	首先是安装guile，因为我用的是gentoo系统，所以我可以直接使用：	doas emerge --ask dev-scheme/guile
* 前言
